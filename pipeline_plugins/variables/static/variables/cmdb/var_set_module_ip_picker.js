                            ...
                            children: [
                                {
                                    ...
                                    attrs: {
                                        ...
                                        remote: true,
                                        remote_url: $.context.get('site_url') + 'pipeline/cc_get_set_list/' + $.context.getBkBizId() + '/',
                                ...
                                },
                                {
                                    ...
                                    attrs: {
                                        name: gettext("筛选集群"),
                                        placeholder: gettext("请输入集群名称，英文逗号分隔")
                                    },
                                },
                                {
                                    ...
                                    attrs: {
                                        name: gettext("筛选模块"),
                                        placeholder: gettext("请输入模块名称，英文逗号分隔")
                                    },
                                },
                                {
                                    ...
                                    attrs: {
                                        ...
                                        placeholder: gettext("请输入模块属性名，英文逗号分隔")
                                    },
                                }
                            ]
                        },
